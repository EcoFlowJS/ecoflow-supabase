...
declare global {
   ...
   * @namespace NodeJS
   * @interface Global
   * @property {(SupabaseClient<any, "public", any>)[]} supabase - The Supabase client instance or null.
   */
  namespace NodeJS {
    /**
     * Represents the global interface that contains the Supabase client instance.
     * @interface Global
     * @property {(SupabaseClient<any, "public", any>)[]} supabase - The Supabase client instance or null if not initialized.
     */
    interface Global {
      /**
...
export default function functionManifest(): ModuleManifest {
  ...
  return {
    ...
    specs: [
      ...
      //  * @property {string} description - A description of the module ("Supabase OAuth module").
